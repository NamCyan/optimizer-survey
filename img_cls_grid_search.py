    ...
    for optimizer in optimizer_param:
        ...
        for param_value1 in optimizer_param[optimizer][param_name1]:
            for param_value2 in optimizer_param[optimizer][param_name2]:
                cmd = "python3 main.py --task img_cls --dataset cifar10 --epochs 1 --batch_size 128 --optim {} --model_name {} --{} {} --{} {} --device cpu".format(optimizer, model, param_name1, param_value1, param_name2, param_value2)
                cmds.append(cmd)
